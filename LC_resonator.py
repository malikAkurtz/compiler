...
from Branch import *
from LCResonatorCircuit import LCResonatorCircuit
...
def main():
    ...
    n                  = 201            # Number of charge states, -n/2 : n/2
    n_trunc            = 201              # number of states to truncate to 
    ...
    # ---- Build Matrices ----
    for v in circuit_graph.vertices:
        print(v.id)
    circuit.build()
