...
def main():
    ...
    n                  = 15            # Number of charge states, -n/2 : n/2
    n_trunc            = 15              # number of states to truncate to 
    ...
    for i in range(4):
        ...
        if PLOT:
            ...
            ax_fock.set_xlabel("Energy State |n⟩", fontsize=12)
            ax_fock.set_ylabel("Probability", fontsize=12)
            ax_fock.set_title(f"Energy Populations", fontsize=14)
